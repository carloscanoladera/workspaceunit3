...
public class EjemploClaseGenerica<T> {
	...
	public static void main(String[] args) {
		...
		EjemploClaseGenerica<Double> dobleGenerico = new EjemploClaseGenerica<Double>(Double.valueOf(1),
				Double.valueOf(2));

		System.out.println("El tipo de mi clase gen�rica es " + dobleGenerico.muestraTipo());

		System.out.println("�Son iguales los dos operandos? La respuesta es " + dobleGenerico.comparacion());

		System.out.println(" Operando 1 es el par�metro. La respuesta es " + dobleGenerico.comparacionExterna(param));

		EjemploClaseGenerica<Integer> integerGenerico = new EjemploClaseGenerica<Integer>(Integer.valueOf(1),
				Integer.valueOf(2));

		System.out.println("El tipo de mi clase gen�rica es " + integerGenerico.muestraTipo());
