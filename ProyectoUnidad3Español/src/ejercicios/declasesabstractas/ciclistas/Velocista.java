...
/**
 * Esta clase denominada Velocista es un tipo de Ciclista caracterizado por
 * poseer gran potencia y alta velocidad punta en esfuerzos cortos. Posee nuevos
 * atributos como la potencia promedio y la velocidad promedio
 * 
 * @version 1.2/2020
 */
public class Velocista extends Ciclista {
	 ...
	 * @param potenciaPromedio  Parámetro que define la potencia promedio de un
	 *                          velocista
	 * @param velocidadPromedio Parámetro que define la velocidad promedio de un
	 *                          velocista
	 */
	 ...
	 * 
	 * @param Parámetro que especifica la potencia promedio de un velocista
	 */
	 ...
	 * 
	 * @param Parámetro que especifica la velocidad promedio de un velocista
	 */
