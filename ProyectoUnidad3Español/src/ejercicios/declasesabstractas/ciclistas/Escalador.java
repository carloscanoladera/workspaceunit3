package ejercicios.declasesabstractas.ciclistas;

/**
 * Esta clase denominada Escalador es un tipo de Ciclista que se encuentra mejor
 * adaptado y se destaca cuando las carreteras son en ascenso, ya sea en colinas
 * o montañas. Posee nuevos atributos como su aceleración promedio y el grado de
 * rampa que soporta
 * 
 * @version 1.2/2020
 */
...
// Atributo que define el grado de rampa soportado por un escalador
	 ...
	 * @param aceleraciónPromedio Parámetro que define la aceleración promedio de un
	 *                            escalador
	 * @param gradoRampa          Parámetro que define el grado de rampa de un
	 *                            escalador
	 */
	 ...
	 * 
	 * @param Parámetro que especifica la aceleración promedio de un escalador
	 */
	 ...
	 * 
	 * @param Parámetro que especifica el grado de rampa soportado por un escalador
	 */
