...
public class Círculo {
	 ...
	 * 
	 * @param x     Parámetro que define la coordenada x de un punto que establece
	 *              el centro del círculo
	 * @param y     Parámetro que define la coordenada y de un punto que establece
	 *              el centro del círculo
	 * @param radio Parámetro que define el radio del círculo
	 */
	public Círculo(int x, int y, int radio) {
		centro = new Punto(x, y); /*
									 * Crea un círculo con los valores pasados como parámetros
									 */
