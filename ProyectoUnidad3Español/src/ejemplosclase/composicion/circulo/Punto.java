...
/**
 * Esta clase denominada Punto que está conformado por una pareja de valores, un
 * valor para la coordenada x y otro para la coordenada y.
 * 
 * @version 1.2/2020
 */
public class Punto {
	int x, y; /*
				 * Atributos que identifican el valor de las coordenadas (x,y) del círculo
				 */
	 ...
	 * 
	 * @param Parámetro que define el valor de la coordenada y de un punto
	 */
	void setY(int y) {
		this.y = y;
