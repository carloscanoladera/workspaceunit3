...
/**
 * Esta clase denominada Cuenta modela una cuenta bancaria con los atributos
 * saldo, número de consignaciones, número de retiros, tasa anual de interés y
 * comisión mensual.
 * 
 * @version 1.2/2020
 */
public class Cuenta {
	 ...
	 */
	/*
	 * Atributo que define el número de consignaciones realizadas en una cuenta
	 * bancaria
	 */
	 ...
	 * la cuenta
	 * 
	 * @param saldo Parámetro que define la cantidad de dinero a consignar en la
	 *              cuenta
	 */
	 ...
	 * cuenta
	 * 
	 * @param saldo Parámetro que define la cantidad de dinero a retirar de la
	 *              cuenta
	 */
	...
	/**
	 * Método que calcula interés mensual de la cuenta a partir de la tasa anual
	 * aplicada
	 */
