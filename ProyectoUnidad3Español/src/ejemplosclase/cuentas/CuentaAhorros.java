...
public class CuentaAhorros extends Cuenta {
	/*
	 * Atributo que identifica si una cuenta está activa; lo está si su saldo es
	 * superior a 10000
	 */
	 ...
	 * @param tasa  Parámetro que define la tasa anual de interés de la cuenta de
	 *              ahorros
	 */
	 ...
	 * cuenta
	 * 
	 * @param saldo Parámetro que define la cantidad a retirar de una cuenta de
	 *              ahorros
	 */
	 ...
	 * la cuenta
	 * 
	 * @param saldo Parámetro que define la cantidad a consignar en una cuenta de
	 *              ahorros
	 */
	...
	public void extractoMensual() {
		/*
		 * Si la cantidad de retiros es superior a cuatro, se genera una comisión
		 * mensual
		 */
		if (numeroRetiros > 4) {
