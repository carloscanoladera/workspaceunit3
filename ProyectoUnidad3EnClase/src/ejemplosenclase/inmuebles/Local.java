...
/**
 * Esta clase denominada Local modela un tipo específico de inmueble que no está
 * destinado para la vivienda que tiene como atributos un tipo que especifica si
 * es un local interno o que da a la calle.
 * 
 * @version 1.2/2020
 */
