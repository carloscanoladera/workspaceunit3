...
/**
 * Esta clase denominada CasaRural modela un tipo específico de casa ubicada en
 * el sector rural
 * 
 * @version 1.2/2020
 */
...
// Atributo que identifica la altitud a la que se encuentra una casa rural
	 ...
	 *                                  inmobiliario de una casa rural
	 ...
	 *                                  tiene una casa rural
	 * @param distanciaCabera           Parámetro que define la distancia de la casa
	 *                                  rural a la cabecera municipal
	 * @param altitud                   Parámetro que define la altitud sobre el
	 *                                  nivel del mar en que se encuentra una casa
	 *                                  rural
	 */
