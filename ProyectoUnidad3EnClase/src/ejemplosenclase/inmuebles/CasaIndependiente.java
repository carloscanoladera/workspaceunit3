...
/**
 * Esta clase denominada CasaIndependiente modela un tipo específico de casa
 * urbana que no está en conjunto cerrado y es completamente independiente de
 * otras casas. Tiene un atributo estático para especificar un valor del área
 * del inmueble.
 * 
 * @version 1.2/2020
 */
...
// Atributo que identifica el valor por área de una casa independiente
	 ...
	 *                                  inmobiliario de una casa independiente
