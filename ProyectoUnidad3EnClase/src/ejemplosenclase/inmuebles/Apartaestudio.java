...
/**
 * Esta clase denominada Apartaestudio modela un tipo específico de apartamento
 * que tiene una sola habitación.
 * 
 * @version 1.2/2020
 */
...
// Atributo que identifica el valor por área de un apartaestudio
	 ...
	 *                                  inmobiliario de un apartaestudio
	 ...
	 */
	public Apartaestudio(int identificadorInmobiliario, int área, String dirección, int númeroHabitaciones,
			int númeroBaños) {
