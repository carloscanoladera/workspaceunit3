...
/**
 * Esta clase denominada CasaUrbana modela un tipo específico de casa destinada
 * para la vivienda localizada en el sector urbano.
 * 
 * @version 1.2/2020
 */
public class CasaUrbana extends Casa {
	 ...
	 *                                  inmobiliario de una casa urbana
	 ...
	 *                                  tiene una casa urbana
	 */
	public CasaUrbana(int identificadorInmobiliario,
			int área, String dirección, int númeroHabitaciones,
