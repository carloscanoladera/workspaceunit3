...
/**
 * Esta clase denominada LocalComercial modela un tipo específico de Local
 * destinado para un uso comercial con atributos como el valor por área y el
 * centro comercial al cual pertenece.
 * 
 * @version 1.2/2020
 */
public class LocalComercial extends Local {
	 ...
	 *                                  inmobiliario de un local comercial
	 ...
	 *                                  comercial (interno o que da a la calle)
	 * @param centroComercial           Parámetro que define el nombre del centro
	 *                                  comercial donde está ubicado el local
	 *                                  comercial
	 */
