...
/**
 * Esta clase prueba diferentes inmuebles, se calcula su precio de acuerdo al
 * área y se muestran sus datos en pantalla
 * 
 * @version 1.2/2020
 */
public class MainInmuebles {
	/**
	 * Método main que crea dos inmuebles, calcula su precio de acuerdo al área y se
	 * muestran sus datos en pantalla
	 */
