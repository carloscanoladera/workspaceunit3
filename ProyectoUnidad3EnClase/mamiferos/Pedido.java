...
public class Pedido {
	/**
	 * Método que tiene como parámetros los elementos que conforman un pedido con un
	 * primer plato, su bebida y sus costos correspondientes. El método calcula el
	 * costo total del pedido y muestra en pantalla los datos del pedido y su costo
	 * total.
	 * 
	 * @param primerPlato      Parámetro que define el nombre del primer plato que
	 *                         conforma el pedido
	 * @param costoPrimerPlato Parámetro que define el costo del primer plato que
	 *                         conforma el pedido
	...
	/**
	 * Método sobrecargado que tiene como parámetros los elementos que conforman un
	 * pedido con un primer plato, un segundo plato, su bebida y sus costos
	 * correspondientes. El método calcula el costo total del pedido y muestra en
	 * pantalla los datos del pedido y su costo total.
	 * 
	 * @param primerPlato       Parámetro que define el nombre del primer plato que
	 *                          conforma el pedido
	 * @param costoPrimerPlato  Parámetro que define el costo del primer plato que
	 ...
	 *                          conforma el pedido
	 * @param costoSegundoPlato Parámetro que define el costo del segundo plato que
	 *                          conforma el pedido
	 * @param bebida            Parámetro que define el nombre de la bebida que
	 *                          conforma el pedido
	 * @param costoBebida       Parámetro que define el costo de la bebida que
	...
	/**
	 * Método sobrecargado que tiene como parámetros los elementos que conforman un
	 * pedido con un primer plato, segundo plato, su bebida, postre y sus costos
	 * correspondientes. El método calcula el costo total del pedido y muestra en
	 * pantalla los datos del pedido y su costo total.
	 * 
	 * @param primerPlato       Parámetro que define el nombre del primer plato que
